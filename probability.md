...
Taleb (2010) defines the "ludic fallacy" as "the manifestation of the Platonic fallacy in the study of uncertainty; basing studies of chance on the narrow world of games and dice. A-Platonic randomness has an additional layer of uncertainty concerning the rules of the game in real life."  The mathematics of games of chance (probability) can plausibly be used when an explicit random or pseudo-random mechanism is used in the selction of subjects from a frame, or to assign subjects to treatments or exposures.  Second best are "natural experiments".  When probability modeling is used for interpreting other forms of observational data, the resulting inferential statements must be heavily caveated (Greenland, 1990; Rothman, 2012).  As Philip B. Stark has [written](https://www.stat.berkeley.edu/~stark/other.htm), "Beware hypothesis tests and confidence intervals in situations with no real randomness."   (An even more skeptical view is given by Feinstein, 1977.)
...
S. Greenland, 1990:  Randomization, statistics, and causal inference.  *Epidemiology*, 1:  421-429.

J. Kay and M. King, 2020:  *Radical Uncertainty: Decision-Making Beyond the Numbers*.  W. W. Norton.

K. J. Rothman, 2012:  *Epidemiology:  An Introduction*, second edition.  Oxford University Press, Chapter 8.

N. N. Taleb, 2010:  *The Black Swan: The Impact of the Highly Improbable*, second edition.  Random House.
